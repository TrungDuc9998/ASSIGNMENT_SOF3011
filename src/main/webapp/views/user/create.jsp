...
<div class="container" style="margin-top:90px">
	<div class="row">
		...
		<div class="col-6">
			...
			<div class="row mt-3">
				<div class="col-6 ">
					<h5 class="ms-3">THÊM MỚI USER</h5>
					<p class="ms-3">Hãy thêm mới người dùng cho hệ thống</p>
				</div>
				...
				<div class="card-body">
					<form action="/ASSIGNMENT_SOF3011/user/store" method="post" enctype="multipart/form-data">
					...
					<c:if test="${!empty sessionScope.error }">
						...
						<div class="form-check form-check-inline">
						  <input class="form-check-input" type="radio" name="admin" id="inlineRadio1" value="0"  >
						  <label class="form-check-label" for="inlineRadio1">Admin</label>
						</div>
						<div class="form-check form-check-inline">
						  <input class="form-check-input" type="radio" name="admin" id="inlineRadio2" value="1" checked>
